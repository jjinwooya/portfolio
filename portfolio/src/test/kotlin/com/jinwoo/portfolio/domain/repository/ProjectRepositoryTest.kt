...
class ProjectRepositoryTest(
    ...
    private fun createProject(n : Int): Project {
        ...
        for (i in 1..n) {
            val projectDetail = ProjectDetail(content = "테스트2 ${i}" , url = null , isActive = true)
    ...
    fun beforeAll() {
        ...
        for (i in 1..DATA_SIZE) {
            ...
            val skill = Skill(name = "테스트는 ${i}", type = skillType[i % skillType.size].name, isActive = true)
            skills.add(skill)
        }
        skillRepository.saveAll(skills)
        println("!!!!!!!!!스킬데이터 초기화 종료")
    ...
    fun testFindAll() {
        ...
        for(project in projects) {
            ...
            println("project title: ${project.details.size}")

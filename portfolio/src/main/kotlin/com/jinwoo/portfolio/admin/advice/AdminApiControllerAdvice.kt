package com.jinwoo.portfolio.admin.advice


import com.jinwoo.portfolio.admin.exception.AdminException
...
class AdminApiControllerAdvice {
    ...
    fun handleException(e: Exception): ResponseEntity<String> {
        ...
        return ResponseEntity.internalServerError().body("시스템오류")
    }
}
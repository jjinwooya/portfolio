package com.jinwoo.portfolio.admin.context.achievement.controller

import com.jinwoo.portfolio.admin.context.achievement.service.AdminAchievementService
import com.jinwoo.portfolio.admin.data.DateFormElementDTO
import com.jinwoo.portfolio.admin.data.FormElementDTO
import com.jinwoo.portfolio.admin.data.SelectFormElementDTO
import com.jinwoo.portfolio.admin.data.TextFormElementDTO
...
class AdminAchievementViewController(
    ...
    fun achievement(model: Model): String {
        ...
        val table = adminAchievementService.getAchievements()
